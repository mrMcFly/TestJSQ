...
#warning (JSQ changes) Indent for sender name left indent
        cell.messageBubbleTopLabel.textInsets = UIEdgeInsetsMake(0.0f, 25.f, 0.0f, 0.0f); //Removed bubbleTopLabelInset constant, replace it with 25.
    }
