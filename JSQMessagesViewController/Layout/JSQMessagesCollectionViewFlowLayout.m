...
#warning (JSQ changes) Avatar size (Default 30.f)
...
#warning (JSQ changes) Indent between cells
    self.minimumLineSpacing = 24.0f;
...
#warning (JSQ changes) Bottom indent for text bubble message (add time label)
