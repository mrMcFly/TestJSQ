...
{
#warning (JSQ changes) Calculating bubble cell size!!!!! 
...
#warning (JSQ changes) Add 18 for message time label height 
        finalSize = CGSizeMake(finalWidth, stringSize.height + verticalInsets + 18);
    }
